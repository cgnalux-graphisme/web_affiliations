...
export const cp12900ProductionDesPatesPapiers: TableCP = {
  cp: "129.00",
  nom: "Production des pates, papiers et cartons",
  employeur: [
    { depuis: "1900-01-01", jours: 154 },
    { depuis: "1979-01-01", jours: 140 },
    { depuis: "1989-01-01", jours: 129 },
